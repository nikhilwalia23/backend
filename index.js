...
app.use(cors({origin: ['http://localhost:3000', 'http://127.0.0.1:3000','https://632ecce7fbe18d55c48fa6af--relaxed-alfajores-1445cf.netlify.app','https://api.razorpay.com'],credentials: true}));
