...
app.use(cors({origin: ['http://localhost:3000/cardetails','http://localhost:3000', 'http://127.0.0.1:3000','https://relaxed-alfajores-1445cf.netlify.app','https://api.razorpay.com'],credentials: true}));
